            ...
            <ul className="flex flex-col list-none lg:flex-row lg:ml-auto">
              ...
              <li className="flex items-center">
                <a
                  ...
                  target="_blank"
                >
                  <i className="text-lg lg:text-blue text-blueGray-500 fab fa-facebook leading-lg " />
              ...
              <li className="flex items-center">
                <a
                  className="flex items-center px-3 py-4 text-xs font-bold uppercase lg:text-white lg:hover:te text-blueGray-700 lg:py-2"
                  href="https://twitter.com/intent/tweet?url=https%3A%2F%2Fdemos.creative-tim.com%2Fnotus-nextjs%2F&text=Start%20your%20development%20with%20a%20Free%20Tailwind%20CSS%20and%20NextJS%20UI%20Kit%20and%20Admin.%20Let%20Notus%20NextJS%20amaze%20you%20with%20its%20cool%20features%20and%20build%20tools%20and%20get%20your%20project%20to%20a%20whole%20new%20level."
                  target="_blank"
                >
                  <i className="text-lg lg:text-blue text-blueGray-500 fab fa-twitter leading-lg " />
              ...
              <li className="flex items-center">
                <a
                  ...
                  target="_blank"
                >
                  <i className="text-lg lg:text-blue text-blueGray-500 fab fa-github leading-lg " />
